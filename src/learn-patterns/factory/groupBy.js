...
// Creating an asynchronous function using an arrow expression
// and saving it to a the variable asyncFunction.
const asyncFunction = async () => {
  // Awaiting the promise to resolve and
  // saving the result to the variable finalResult.
